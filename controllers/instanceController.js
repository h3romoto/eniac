...
const buildInstance = async (req, res) => {
  try {
    ...
    const resultPromise = execAsync("cd terraform && terraform refresh && terraform plan && terraform apply -auto-approve"); //terraform refresh; terraform plan; terraform apply -auto-approve
